...
export default {
  ...
  mounted () {
    // listeners para recalcular tamaño del mapa
  ...
  methods: {
    ...
    buildIcons () {
      ...
      this.icons.default = mk('#2563eb', '#1e40af', 40)
      this.icons.active = active(48)
...
<style scoped>
/* contenido */
.page-wrapper{ padding-top: 12px; max-width: 1280px; margin: 0 auto; }
