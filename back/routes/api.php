...
Route::get('/top-sellers', [\App\Http\Controllers\SalesController::class, 'topSellers']);
Route::get('carouselsMedio', [\App\Http\Controllers\CarouselController::class, 'carouselsMedio']);

// ✅ Sugerencias predictivas (debe ir ANTES del resource /products)
...
Route::group(['middleware' => 'auth:sanctum'], function () {
    ...
    Route::post('/transferencias-multiples', [\App\Http\Controllers\ProductController::class, 'transferenciasMultiples']);
